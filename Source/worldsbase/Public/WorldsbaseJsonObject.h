...
class WORLDSBASE_API UWorldsbaseJsonObject : public UObject
{
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	UWorldsbaseJsonValue* GetField(const FString& FieldName) const;

	/** Add a field named FieldName with a Value */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	void SetField(const FString& FieldName, UWorldsbaseJsonValue* JsonValue);

	/** Get the field named FieldName as a Json Array */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	TArray<UWorldsbaseJsonValue*> GetArrayField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of Json Array */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	void SetArrayField(const FString& FieldName, const TArray<UWorldsbaseJsonValue*>& InArray);

	/** Adds all of the fields from one json object to this one */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	void MergeJsonObject(UWorldsbaseJsonObject* InJsonObject, bool Overwrite);
	...
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	UWorldsbaseJsonObject* GetObjectField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of JsonObject */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	void SetObjectField(const FString& FieldName, UWorldsbaseJsonObject* JsonObject);
...
private:
	...
	TArray<T> GetTypeArrayField(const FString& FieldName) const
	{
		...
		for (TArray<TSharedPtr<FJsonValue>>::TConstIterator It(JsonArrayValues); It; ++It)
		{
			...
			{
				UE_LOG(LogWorldsbase, Error, TEXT("Not Number element in array with field name %s"), *FieldName);
			}
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	TArray<UWorldsbaseJsonObject*> GetObjectArrayField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of Ob Array */
	UFUNCTION(BlueprintCallable, Category = "Worldsbase|Json")
	void SetObjectArrayField(const FString& FieldName, const TArray<UWorldsbaseJsonObject*>& ObjectArray);
