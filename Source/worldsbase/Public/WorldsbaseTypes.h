...
#include "WorldsbaseTypes.generated.h"

/** Verb (GET, PUT, POST) used by the request */
UENUM(BlueprintType)
enum class EWorldsbaseRequestVerb : uint8
{
	GET,
	POST,
	PUT,
...
UENUM(BlueprintType)
enum class EWorldsbaseRequestContentType : uint8
{
...
UENUM(BlueprintType)
enum class EWorldsbaseRequestStatus : uint8
{
...
UENUM(BlueprintType)
namespace EWorldsbaseHttpStatusCode
{
/**
...
struct WORLDSBASE_API FWorldsbaseURL
{
	GENERATED_BODY()
